...
interpolation_5g <- readRDS("./result/interpolation_5locus/interpolation_5g_tm_Netdiv.rds")

pdf("../../../rosid_2nd/Figures/plot/Fig. S1. Correlation between net diversification rosid orders and historical global temperature.pdf", height = 10, width = 7)
